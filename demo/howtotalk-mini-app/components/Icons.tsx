...
export const SmileLogo: React.FC<IconProps> = ({ className = "w-24 h-24" }) => (
  <div className={`rounded-full bg-orange-500 flex items-center justify-center ${className}`}>
    <svg 
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      {/* Abstract stylized smile/face similar to the screenshot */}
      <path 
        d="M20 40 C 20 75, 80 75, 80 40" 
        stroke="white" 
        strokeWidth="8" 
        strokeLinecap="round" 
      />
...
export const MiniLogo: React.FC<{className?: string}> = ({ className }) => (
  <div className={`flex items-center gap-1 ${className}`}>
    <div className="w-5 h-5 rounded-full bg-white flex items-center justify-center">
       <div className="text-orange-500 font-bold text-[10px]">L</div>
    </div>
    <span className="text-white font-semibold text-sm tracking-wide">howtotalk.</span>
  </div>
);
...
export const HomeIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    ...
    <path d="M12 5.432 5.15 12.283A1.196 1.196 0 0 1 5.378 13.9a1.193 1.193 0 0 1-1.128.537h.575v5.188a2.25 2.25 0 0 0 2.25 2.25h9.75a2.25 2.25 0 0 0 2.25-2.25V14.44h.572a1.195 1.195 0 0 1-1.124-.535 1.196 1.196 0 0 1 .225-1.621L12 5.432Z" />
  </svg>
);

export const TestIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path fillRule="evenodd" d="M7.502 6h7.128A3.375 3.375 0 0 1 18 9.375v9.375a3 3 0 0 0 3-3V6.108c0-1.505-1.125-2.811-2.664-2.94a48.972 48.972 0 0 0-.673-.05A3 3 0 0 0 15 1.5h-1.5a3 3 0 0 0-2.663 1.618c-.225.015-.45.032-.673.05C8.662 3.295 7.554 4.542 7.502 6ZM13.5 1.5h-3c.621 0 1.16.376 1.376.923a51.13 51.13 0 0 0 .248 0C12.34 1.876 12.879 1.5 13.5 1.5Zm-7.875 6h9.75a2.25 2.25 0 0 1 2.25 2.25v7.5a2.25 2.25 0 0 1-2.25 2.25h-9.75a2.25 2.25 0 0 1-2.25-2.25v-7.5a2.25 2.25 0 0 1 2.25-2.25Z" clipRule="evenodd" />
   </svg>
);
...
export const FlagIcon: React.FC<{className?: string}> = ({ className = "w-6 h-6" }) => (
  <div className={`relative ${className}`}>
      {/* Circle bg */}
      <div className="w-full h-full rounded-full bg-[#FFE4CF] flex items-center justify-center">
          {/* Flag Pole */}
          <div className="relative w-1/2 h-2/3">
             <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-orange-500 rounded-full" />
             <div className="absolute left-1 top-1 w-full h-1/2 bg-[#FDBA74] rounded-sm flex items-center justify-center shadow-sm">
                 <div className="flex flex-col items-center leading-none">
                    <span className="text-[9px] text-white font-bold">今日</span>
                    <span className="text-[9px] text-white font-bold">建议</span>
                 </div>
             </div>
          </div>
      </div>
...
export const CheckCircleIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`text-green-500 ${className}`}>
...
export const CurrencyYenIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const PuzzlePieceIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 6.087c0-.355.186-.676.401-.959.221-.29.349-.634.349-1.003 0-1.036-1.007-1.875-2.25-1.875s-2.25.84-2.25 1.875c0 .369.128.713.349 1.003.215.283.401.604.401.959v0a.64.64 0 01-.657.643 48.39 48.39 0 01-4.163-.3c.186 1.613.293 3.25.315 4.907a.656.656 0 01-.658.663v0c-.355 0-.676-.186-.959-.401a2.247 2.247 0 00-1.003-.349c-1.036 0-1.875 1.007-1.875 2.25s.84 2.25 1.875 2.25c.369 0 .713-.128 1.003-.349.283.215.604-.401.959-.401v0c.31 0 .555.26.532.57a48.039 48.039 0 01-.642 5.056c1.518.19 3.058.309 4.616.354a.64.64 0 00.663-.664v0c0-.355-.186-.676-.401-.959a2.247 2.247 0 00-.349-1.003c0-1.035 1.008-1.875 2.25-1.875 1.243 0 2.25.84 2.25 1.875 0 .369-.128.713-.349 1.003-.215.283-.4.604-.4.959v0c0 .333.277.599.61.58a48.1 48.1 0 005.427-.63 48.05 48.05 0 00.582-4.717.532.532 0 00-.533-.57v0c-.355 0-.676.186-.959.401-.29.221-.634.349-1.003.349-1.035 0-1.875-1.007-1.875-2.25s.84-2.25 1.875-2.25c.37 0 .713.128 1.003.349.283.215.604.401.959.401v0c.31 0 .555-.26.532-.57a48.039 48.039 0 01-.642-5.056z" />
  </svg>
);
...
export const AcademicCapIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.499 5.24 51.558 51.558 0 01-19.823 4.53m15.482 0A50.459 50.459 0 0112 13.489a50.459 50.459 0 01-2.228-.05m15.482 0c-.169 0-.337.01-.504.03m-15.482 0c.169 0 .337.01.504.03m15.482 0A50.6 50.6 0 0012 13.489a50.61 50.61 0 00-2.228-.05" />
  </svg>
);
