...
Page({
  data: {
    ...
    courses: [
      { id: 1, title: "Effective Communication with children", subtitle: "OF 2-12 YEARS", imageUrl: "https://picsum.photos/id/342/400/600" },
  ...
  onLoad() {
    fetchRandomQuote()
      .then((quote) => {
        if (quote) this.setData({ heroQuote: quote });
      })
      .catch(() => {});
  },
  onBookmark() {
