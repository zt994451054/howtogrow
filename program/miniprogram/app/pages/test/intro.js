...
function mockItems() {
  ...
  return [
    ...
    },
    {
      ...
      questionType: "SINGLE",
      options: [option(1101, "“别哭了，我来帮你穿好就行了。”", 1), option(1102, "“哭也没用，自己想办法穿上。”", 2), option(1103, "“这双鞋确实有点难穿，我们要不要试试松开鞋带？”", 3)],
    },
    { displayOrder: 3, questionId: 103, content: "当孩子拒绝分享玩具时，你通常会怎么说？（单选）", questionType: "SINGLE", options: [option(1201, "“要做个大方的孩子，快给弟弟玩一会儿。”", 1), option(1202, "“这是你的玩具，你有权决定什么时候分享。”", 2)] },
    { displayOrder: 4, questionId: 104, content: "面对孩子的情绪崩溃，你的第一反应是？", questionType: "SINGLE", options: [option(1301, "“别哭了，给你买糖吃。”", 1), option(1302, "拥抱并说：“我知道你现在很难过。”", 2)] },
    { displayOrder: 5, questionId: 105, content: "到了睡觉时间孩子还在玩，你会怎么做？", questionType: "SINGLE", options: [option(1401, "直接关灯，强行抱上床。", 1), option(1402, "“你是想先刷牙还是先换睡衣？选好了我们就去睡觉。”", 2)] },
  ];
}
