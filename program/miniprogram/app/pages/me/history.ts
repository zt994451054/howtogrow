...
function mockItems(): DailyAssessmentItemView[] {
  ...
  return [
    ...
    },
    {
      displayOrder: 2,
      questionId: 102,
      content: "当孩子拒绝分享玩具时，你通常会怎么说？",
      questionType: "SINGLE",
      options: [option(1201, "“要做个大方的孩子，快给弟弟玩一会儿。”", 1), option(1202, "“这是你的玩具，你有权决定什么时候分享。”", 2)],
    },
    {
      displayOrder: 3,
      questionId: 103,
      content: "面对孩子的情绪崩溃，第一反应是？",
      questionType: "SINGLE",
    ...
    },
    {
      displayOrder: 4,
      questionId: 104,
      content: "孩子这也不吃那也不吃，吃饭时你通常会？",
      questionType: "SINGLE",
      options: [option(1401, "“必须把青菜吃掉，不然不许看电视。”", 1), option(1402, "“那尝尝胡萝卜怎么样？”", 2)],
    },
    {
      displayOrder: 5,
      questionId: 105,
      ...
      questionType: "SINGLE",
      options: [option(1501, "直接关灯，强行抱上床。", 1), option(1502, "“你是想先刷牙还是先换睡衣？”", 2)],
    },
  ];
}
...
Page({
  ...
  onView(e: WechatMiniprogram.BaseEvent) {
    const id = String((e.currentTarget as any).dataset.id);
